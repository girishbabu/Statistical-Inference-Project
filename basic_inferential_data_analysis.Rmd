---
title: 'Statistical Inference - Coursera Week 3 Project: Basic Inferential Data Analysis'
author: "Girish Babu"
date: "21 September 2014"
output: pdf_document
---

In this exercise, we're going to analyze the ToothGrowth data in the R datasets package - 
1. Load the ToothGrowth data and perform some basic exploratory data analyses 
2. Provide a basic summary of the data.
3. Use confidence intervals and hypothesis tests to compare tooth growth by supp and dose. 
4. State conclusions and the assumptions needed for the conclusions. 

The data is set of 60 observations, length of odontoblasts (teeth) in each of 10 guinea pigs 
at each of three dose levels of Vitamin C  (0.5, 1 and 2 mg) with each of two delivery methods 
...
Plot above shows there is a clear positive correlation between length of a 
tooth and the dosage levels of Vitamin C, for either delivery methods.
